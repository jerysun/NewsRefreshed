...
import (
	...
	_ "github.com/lib/pq" // Add this import with the underscore
)
...
func main() {
  ...
  dbQueries := database.New(db) // dbQueries type: *database.Queries. database is a package generated by sqlc
